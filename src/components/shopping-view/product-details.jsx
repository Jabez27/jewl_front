...
function ProductDetailsDialog({ open, setOpen, productDetails }) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogClose}>
      <DialogContent
  className="grid grid-cols-1 sm:grid-cols-2 gap-8 p-4 sm:p-8 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw] overflow-y-auto"
>
  ...
  <div>
    <div>
      ...
      <p className="text-muted-foreground text-base sm:text-2xl mb-4 sm:mb-5 mt-3 sm:mt-4">
